...
const faqs = [
    ...
    { q: '¿Qué diferencia a MC Fitness de otros gimnasios?', a: 'En MC Fitness combinamos equipamiento de calidad premium y entrenadores profesionales con un ambiente familiar donde todos se conocen. Además, somos los únicos con sillas masajeadoras para recuperación muscular.' },
