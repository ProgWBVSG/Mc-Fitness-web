            ...
            <div className="container">
                <div className={styles.inner}>
                    <div className={`${styles.left} fade-up`}>
                        ...
                        <h2>No es solo otro gimnasio.<br />
                            <span className={styles.highlight}>Es MC Fitness.</span>
                        </h2>
                    </div>
                    <div className={`${styles.right} fade-up delay-2`}>
                        <p>
                            En MC Fitness combinamos lo mejor de dos mundos: la calidad y el equipamiento premium con la calidez y el sentido de comunidad donde todos se conocen.
                        </p>
                        <p>
